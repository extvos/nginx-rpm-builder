...
Source12: ngx_slowfs_cache.tar.gz
Source13: nginx-module-vts.tar.gz
...
./configure \
        ...
        --add-module=%{_builddir}/%{name}-%{version}/ngx_slowfs_cache \
        --add-module=%{_builddir}/%{name}-%{version}/nginx-module-vts \
