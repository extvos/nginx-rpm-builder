...
# 
# wget http://www.keepalived.org/software/keepalived-1.2.19.tar.gz -O ~/rpmbuild/SOURCES/keepalived-1.2.19.tar.gz
# 
...
%changelog
* Sat Jun 29 2013 Nathan Milford <nathan@milford.io> 1.2.19
- Updated to 1.2.19
